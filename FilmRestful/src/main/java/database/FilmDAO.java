...
public class FilmDAO {
	...
	public boolean insertFilm(Film f) throws SQLException { // method to insert films
	...
	public boolean updateFilm(Film f) throws SQLException { // method to update films
	...
	public boolean deleteFilm(Film f) throws SQLException { // method to delete films
